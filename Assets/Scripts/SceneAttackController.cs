...
public class SceneAttackController : MonoBehaviour
{
    ...
    IEnumerator MissileAttack()
    {
        ...
        while(timer < aimTime)
        {
            float[] xs = {mousePos.x / Screen.width, 0.98f, mousePos.x / Screen.width, 0.02f};
            float[] ys = {0.02f, mousePos.y / Screen.height, 0.98f, mousePos.y / Screen.height};
